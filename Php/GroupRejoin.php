...
<?php include_once '../Php/header.php' ?>
  ...
  $r = $db->prepare("select intitule, description, cl.identifiant, Actif, Prive from club cl join lienutcl l on cl.identifiant = l.idCl join utilisateur u on l.idUt = u.id WHERE u.id = :id");
